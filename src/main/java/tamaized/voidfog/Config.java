...
public class Config {
	...
	private Config setup(ModConfigSpec.Builder builder) {
		y = builder.
				...
				defineInRange("y", 32, 0, Integer.MAX_VALUE);
		distance = builder.
				...
				defineInRange("distance", 10, 0, Double.MAX_VALUE);
		...
		blacklistedDims = builder.
				...
				defineListAllowEmpty("dimension_blacklist", new ArrayList<>(), () -> "", s -> s instanceof String string && Identifier.tryParse(string) != null);
